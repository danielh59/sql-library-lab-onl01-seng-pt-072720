...
INSERT INTO characters (id, name, motto, species, author_id, series_id) VALUES (5, "Snape", "Always", "human", 1, 1), (6, "Hagrid", "Harry — yer a wizard.", "giant/human", 1, 1), (7, "Character Three", "Don't worry. You're just as sane as I am.", "cylon", 1, 1), (8, "Character Four", "motto four", "cylon", 1, 1);
