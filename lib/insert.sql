...
INSERT INTO characters (id, name, motto, species, author_id, series_id) VALUES (1, "Tywin Lannister", "A lion doesn’t concern himself with the opinions of a sheep", "human", 1, 2), (2, "Tyrion Lanister", "A Lanister always pays is debts", "human", 1, 2), (3, "Daenerys Targaryen", "If I look back I am lost", "human", 1, 2), (4, "Eddard Stark", "Winter is coming", "human", 1, 2);
